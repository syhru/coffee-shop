  ...
  return (
    <section className="pb-32 bg-coffee-background dark:bg-transparent">
      <div className="max-w-screen-xl mx-auto px-8">
        <div className="p-4 sm:p-5 md:p-20 pb-4 bg-coffee-secondary/20 dark:bg-[#161311] rounded-xl flex flex-col md:flex-row gap-4 md:gap-12 items-start md:items-center editorial-shadow dark:border dark:border-coffee-outline">
          <div className="w-full md:w-1/3 shrink-0 aspect-[3/4] sm:aspect-square md:aspect-auto relative rounded-xl overflow-hidden flex items-center justify-center">
          ...
          <div className="flex-1 min-w-0 pr-1 pb-1 md:w-2/3 flex flex-col justify-center text-left w-full">
            <h3 className="text-base sm:text-base md:text-3xl font-serif text-coffee-primary dark:text-coffee-cream mb-1 md:mb-2 leading-tight text-left">Arabica Whine Strong</h3>
            ...
            <p className="break-words whitespace-normal text-justify md:text-justify font-sans text-coffee-secondary dark:text-coffee-cream/80 text-[11px] sm:text-xs md:text-lg mb-2 md:mb-10 italic mt-3 leading-relaxed">
            ...
            <div className="flex flex-row items-center justify-between w-full mt-4 gap-2 md:flex-row md:items-center md:justify-start md:gap-8 md:mt-6">
              <span className="text-base md:text-xl shrink-0 font-serif font-bold text-coffee-primary dark:text-coffee-cream">IDR 245.000</span>
              <button className="w-auto flex justify-center items-center text-center text-[9px] px-3 py-2 rounded-full md:w-auto md:px-8 md:py-4 sm:text-[10px] md:text-sm whitespace-nowrap bg-coffee-primary dark:bg-coffee-goldlight text-white dark:text-coffee-midnight font-sans font-semibold uppercase tracking-widest hover:opacity-90 transition-opacity md:rounded-lg editorial-shadow">
                Add to Collection
              </button>
            </div>
          </div>
